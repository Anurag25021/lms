...
const AddCourse = () => {
  ...
  const handeLecture = (action, chapterId, lectureIndex) => {
    if (action === 'add') {
  ...
  return (
    <div className='h-screen overflow-scroll flex flex-col items-start justify-between md:p-8 md:pb-0 p-4 pt-8 pb-0'>
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 mac-w-md w-full text-gray-500'>
              ...
              {!chapter.collapsed && (
                <div className='p-4'>
                  {chapter.chapterContent.map((lecture, lectureIndex) => (
                    <div key={lectureIndex} className='flex justify-between items-center mb-2'>
                      ...
                      <img
                        src={assets.cross_icon}
                        alt=''
                        onClick={() => handeLecture('remove', chapter.chapterId, lectureIndex)}
                        className='cursor-pointer'
                      />
                    </div>
                  ))}
                  <div
                    ...
                    onClick={() => handeLecture('add', chapter.chapterId)}
                  >
                    + Add Lecture
                  </div>
                </div>
